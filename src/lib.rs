...
impl Agari {
    ...
    pub fn points(&self, kiriage: bool) -> RonOrTsumo {
...
impl Score {
    pub fn points(&self, tsumo: bool, dealer: bool, kiriage: bool) -> RonOrTsumo {
        {
...
mod tests {
    ...
    fn tsumo(result: RonOrTsumo) -> [i32; 2] {
        match result {
